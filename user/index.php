        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center">
                    <h2 class="text-white-50"> University Of Agriculture <br> Complaint Management System</h2>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-end">
                                <small class="text-muted">
                                    Need help? <a href="mailto:complaint@uwu.ac.lk" class="text-decoration-none">Contact Support</a>
                                </small>
                            </div>
                        </div>
                    </div>
